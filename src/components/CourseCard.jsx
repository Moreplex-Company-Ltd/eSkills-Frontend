...
const CourseCard = () => {
  return (
    <div className="h-30 w-[270px] flex flex-col text-gray-900 bg-white rounded-xl shadow">
          <div className="rounded-lg bg-white shadow-md">
            <img src={soapImage} className="w-full rounded-t-lg" alt='imgg' />
            <div className="px-3 py-2">
              <div className='flex justify-between'>
                <p className='font-poppins font-bold text-xs'><span className='font-extrabold'>13,734</span> students</p>
                <p className='font-poppins font-bold text-xs'>1h 35m</p>
              </div>
