...
const CourseLoadingCard = () => {
  ...
  return (
    <div className="">
        <div role="status" className="p-2 max-w-sm rounded border border-gray-200 shadow animate-pulse md:p-4 dark:border-gray-700">
            ...
            <div className='flex justify-between w-full'>
                <div className="h-2.5 bg-gray-200 rounded-full w-[20%] mb-4"></div>
                <div className="h-2.5 bg-gray-200 rounded-full w-[20%] mb-0"></div>
            </div>
