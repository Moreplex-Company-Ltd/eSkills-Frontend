    ...
    <section className="relative bg-white">
            ...
            <div className="relative max-w-screen-xl px-4 pt-20 pb-10 sm:py-32 mx-auto  lg:items-center lg:flex">
                ...
                <div className="flex flex-wrap gap-4 mt-8 text-center">
                    <Link to='/get-started' className="block w-full px-12 py-2 text-sm sm:text-lg font-bold text-white rounded shadow bg-rose-600 sm:w-auto active:bg-rose-500 hover:bg-rose-700 focus:outline-none focus:ring" >
                        Start Learning
                    </Link>
