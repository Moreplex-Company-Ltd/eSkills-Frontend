  ...
  return (
    <React.Fragment>
        ...
        <section className='w-screen h-full bg-grayBackground items-center justify-center py-36'>
            <div className='container mx-auto  py-20  bg-white shadow-md rounded'>
            <div className='container text-center p-10'>
            <p className='text-center text-black font-bold text-2xl mb-4'>Terms of Use</p>
...
via email: copyright@coursera.org
...
If you cancel your paid enrollment for a standalone course, Coursera will offer you a complete refund until 14 days after payment, or until you have earned your course certificate, whichever is earlier. If you pre-enroll and pay for a course, Coursera will offer you a complete refund until 14 days after the course launches or until you have earned your course certificate, whichever is earlier. For avoidance of doubt, once you have earned a course certificate with your payment, you are not eligible for a refund even if it is within 14 days. If you do not earn your course certificate within 180 days, your registration will expire and you will need to pay to re-enroll for the course. However, if you’re taking a course through your company, organization, or a Coursera sponsored program (e.g. Coursera for Business, Coursera for Governments or Organizations, Coursera for Refugees, or other Coursera Social Good programs ) then you can earn your certificate as long as your company's contract with Coursera is active and your access has not expired in accordance with the terms of that contract or Coursera is still running a sponsored program. Similarly, refunds and cancellations will also be governed by the terms of that contract between your organization and Coursera.
...
My answers to homework, quizzes, exams, projects, and other assignments will be my own work (except for assignments that explicitly permit collaboration) as specified in the Coursera Plagiarism Policy.
