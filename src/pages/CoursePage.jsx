  ...
  return (
    <React.Fragment>
        ...
        <section className='h-full w-full pt-16'>
            <div className='border pt-16 border-red-700 bg-gray-600'>
                <div className=''>
                    <h1 className='mb-3 text-2xl tracking-tight font-bold text-primaryBlue  ml-10 md:text-4xl'>{courseTitle}</h1>
                    <hr />
