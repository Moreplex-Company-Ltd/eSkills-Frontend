                ...
                <div className="w-full lg:w-1/2 xl:w-6/12 px-4">
                    ...
                    <div className="flex mb-8 max-w-[370px] w-full">
                        ...
                        <div className="w-full">
                            <h4 className="font-bold text-dark text-xl mb-1 text-gold">Our Location</h4>
                            <p className="text-base text-body-color">
                                Center for Business Developement, KNUST Musuem, KNUST
                            </p>
                        </div>
                    </div>
                    <div className="flex mb-8 max-w-[370px] w-full">
                        ...
                        <div className="w-full">
                            <h4 className="font-bold text-dark text-xl mb-1 text-gold">Phone Number</h4>
                            <p className="text-base text-body-color">+233(0)54 346 0633</p>
                        </div>
                    </div>
                    <div className="flex mb-8 max-w-[370px] w-full">
                        <div
                        ...
                        <div className="w-full">
                            <h4 className="font-bold text-dark text-xl mb-1 text-gold">
                                Email Address
                            </h4>
                            <p className="text-base text-body-color">info@elearning.moreplexgh.com</p>
                        </div>
                    </div>
                    </div>
                </div>
