  ...
  return (
    <React.Fragment>
        ...
        <NavbarSignedIn />
            ...
            <section className='hidden sm:block container mx-8 sm:mx-auto relative h-screen overflow-hidden md:flex my-16 '>
                {/* left side bar */}
                ...
                <div className='hidden sm:block flex-1 pl-4  text-2xl font-bold  h-screen overflow-y-auto '>
                    ...
                    <button className='px-5 py-1.5 text-black font-bold text-sm border border-black rounded hover:bg-primaryBlue hover:text-white'><Link to='/allcourses'>View All</Link></button>
                    </div>
            ...
            <section className='sm:hidden w-full my-20 flex items-center justify-center border border-red-700'>
                {/* right main content -> mobile */}
                <div className='container mx-auto px-8  text-2xl font-bold '>
                    <div className=' mb-20'>
                    <div className='flex justify-between items-start'>
                    <h1 className='mb-5 text-primaryBlue font-bold text-xl sm:text-3xl'>Popular Courses</h1>
                    <button className='px-5 py-1.5 text-black font-bold text-sm border border-black rounded hover:bg-primaryBlue hover:text-white'><Link to='/allcourses'>View All</Link></button>
