...
barriers to quality education for all.</p>
        ...
        <section className="bg-white ">
            <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
            <h1 className='text-center mb-8 text-3xl tracking-tight font-bold text-primaryBlue md:text-4xl '>How we are Contributing to the SDGs</h1>
                <div className='flex justify-between items-center'>
                ...
                <figure className="max-w-screen-md mx-auto">
                    ...
                    <blockquote>
                        <p className="text-2xl font-medium text-gray-900 ">
                        <span className='font-bold text-secondaryBlue'>SDG 4:</span> MESA removes the barriers to quality vocational and technical education and make it available to anyone and anywhere around the world. MESA makes learning opportunities available to everyone anytime promoting lifelong learning for all in line with the SDG 4</p>
                    </blockquote>
                </figure>
                ...
                <figure className="max-w-screen-md mx-auto">
                    ...
                    <blockquote>
                        <p className="text-2xl font-medium text-gray-900 ">
                        <span className='font-bold text-secondaryBlue'>SDG 8:</span> The goal of the MESA platform is to connect the world to the opportunity of skilling up and prosper. The platform only not teach practical vocational and technical skills also teaches and offer guidance on how to commercialize and enterprise the obtained skills in order to create economic opportunities for themselves and their families.
                        </p>
                    </blockquote>
                </figure>
