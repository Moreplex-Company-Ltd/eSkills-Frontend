...
// this is supposed to be a accodian component
  ...
  return (
    <React.Fragment>
      ...
      <Accordian >
        <AccordianItem>
          <h2 id="accordion-1">
            <button type="button" className="flex items-center justify-between w-full p-5 font-medium text-left border border-b-0 border-gray-200 rounded-t-xl focus:ring-4 focus:ring-gray-200  hover:bg-gray-100  bg-gray-100  text-gray-900 dark:text-white" data-accordion-target="#accordion-body-1" aria-expanded="true" aria-controls="accordion-collapse-body-1">
          ...
          <div id="accordion-body-1" className="" aria-labelledby="accordion-1">
